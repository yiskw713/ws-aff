...
class DRN(nn.Module):
    ...
    def forward(self, x):
        ...
        x_obj = self.maxpool(x_obj)
        x_aff = self.maxpool(x_aff)
...
def drn_c_58_max(pretrained=False, **kwargs):
...
def drn_d_54_max(pretrained=False, **kwargs):
...
def drn_d_105_max(pretrained=False, **kwargs):
