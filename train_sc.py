...
def train(model, sample, seed, constrain, optimizer, config, device):
...
def main():
    ...
    for epoch in range(CONFIG.max_epoch):
        ...
        for sample in tqdm.tqdm(train_loader, total=len(train_loader)):
            ...
            epoch_loss += train(
                model, sample, seed, constrain, optimizer, CONFIG, args.device
            )
        ...
        if writer is not None:
            ...
            writer.add_scalars("iou", {'mean_iou': mean_iou[-1],
